...
<div class="dashboard-container">
    ...
    <div class="page-header">
        ...
        <div>
            <div class="breadcrumb">
                ADMIN PANEL / KELOLA ALAT / EDIT ALAT
            </div>

            <h1>Edit Alat</h1>

            <p>
                Perbarui informasi alat camping yang ada di CampRent.
            </p>
        </div>
    ...
    <div class="form-card">
        ...
        <form
            action="{{ route('admin.barang.update', $barang) }}"
            method="POST"
        >
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        >
                            ...
                            <option value="Tenda"
                                {{ old('kategori', $barang->kategori) == 'Tenda' ? 'selected' : '' }}>
                                Tenda
                            </option>

                            <option value="Sleeping Bag"
                                {{ old('kategori', $barang->kategori) == 'Sleeping Bag' ? 'selected' : '' }}>
                                Sleeping Bag
                            </option>

                            <option value="Carrier"
                                {{ old('kategori', $barang->kategori) == 'Carrier' ? 'selected' : '' }}>
                                Carrier
                            </option>

                            <option value="Kompor"
                                {{ old('kategori', $barang->kategori) == 'Kompor' ? 'selected' : '' }}>
                                Kompor
                            </option>

                            <option value="Peralatan Masak"
                                {{ old('kategori', $barang->kategori) == 'Peralatan Masak' ? 'selected' : '' }}>
                                Peralatan Masak
                            </option>

                            <option value="Penerangan"
                                {{ old('kategori', $barang->kategori) == 'Penerangan' ? 'selected' : '' }}>
                                Penerangan
                            </option>

                            <option value="Aksesoris"
                                {{ old('kategori', $barang->kategori) == 'Aksesoris' ? 'selected' : '' }}>
                                Aksesoris
                            </option>
