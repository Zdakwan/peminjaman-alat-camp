...
<div class="dashboard-container">
    ...
    <div class="page-header">
        <div>
            <div class="breadcrumb">ADMIN PANEL / KELOLA ADMIN / EDIT ADMIN</div>
            <h1>Edit Admin</h1>
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full">
                        ...
                        <input type="text" id="nama_admin" name="nama_admin" value="{{ old('nama_admin', $admin->nama_admin) }}" required>
                    </div>
